...
class AbstractAttachment(models.Model):
    ...
    file = models.FileField(upload_to=get_attachment_file_upload_to, verbose_name=_('Plik'))
    comment = models.CharField(max_length=255, verbose_name=_('Komentarz'), blank=True, null=True)
