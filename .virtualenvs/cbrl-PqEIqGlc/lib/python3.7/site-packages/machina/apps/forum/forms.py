    ...
    def clean(self):
        ...
        if user and anonymous_user:
            self._errors[NON_FIELD_ERRORS] = self.error_class(
                [_('Wybierz ID użytkownika lub wybierz użytkownika anonimowego'), ],
            )
        return cleaned_data
...
class PermissionsForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        f_choices = (
            (self.PERM_NOT_SET, _('Nie ustawione')),
            (self.PERM_GRANTED, _('Przyznane')),
            (self.PERM_NOT_GRANTED, _('Nie przyznane')),
        )
