...
class SearchForm(FacetedSearchForm):
    ...
    search_topics = forms.BooleanField(label=_('Szukaj tylko w tytułach'), required=False)

    search_poster_name = forms.CharField(
        label=_('Szukaj użytkownika'),
        help_text=_('Wpisz nazwę uzytkownika aby zawęzić wyszukiwanie.'),
        max_length=255, required=False,
    )

    search_forums = forms.MultipleChoiceField(
        label=_('Szukaj w wybranych forach'),
        help_text=_('Wybierz fora na których chcesz szukać.'),
        required=False,
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Update some fields
        self.fields['q'].label = _('Szukaj słowa.')
        self.fields['q'].widget.attrs['placeholder'] = _('Tagi lub słowa')
        self.fields['search_poster_name'].widget.attrs['placeholder'] = _('Nazwa użytkownika')
