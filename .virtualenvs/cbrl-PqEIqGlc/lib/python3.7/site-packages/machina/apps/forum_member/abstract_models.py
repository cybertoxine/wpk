...
class AbstractForumProfile(models.Model):
    ...
    avatar = ExtendedImageField(
        null=True, blank=True, upload_to=get_profile_avatar_upload_to, verbose_name=_('Awatar'),
        **machina_settings.DEFAULT_AVATAR_SETTINGS
    )

    # The user's signature.
    signature = MarkupTextField(
        verbose_name=_('Podpis'), blank=True, null=True,
        validators=[
    ...
    posts_count = models.PositiveIntegerField(verbose_name=_('Liczba postów'), blank=True, default=0)
