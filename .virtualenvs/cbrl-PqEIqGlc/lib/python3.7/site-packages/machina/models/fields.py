...
class ExtendedImageField(models.ImageField):
    ...
    def clean(self, *args, **kwargs):
        ...
        if self.max_upload_size and hasattr(image, 'size'):
            if image.size > self.max_upload_size:
                raise ValidationError(
                    _('Pliki o rozmiarze więkrzym niż {} nie są dozwolone. Twój plik ma {}').format(
        ...
        if self.min_width and self.max_width \
            ...
            raise ValidationError(
                _('Zdjęcia o szerokości mniejszej niż {}px lub większej niż {}px nie '
                  'są dozwolone.Szerokość Twojego zdjęcia to {}px').format(
        ...
        if self.min_height and self.max_height \
            ...
            raise ValidationError(
                _('Zdjęcia o wysokości mniejszej niż {}px lub większej niż {}px nie '
                  'są dozwolone.Wysokość Twojego zdjęcia to {}px').format(
