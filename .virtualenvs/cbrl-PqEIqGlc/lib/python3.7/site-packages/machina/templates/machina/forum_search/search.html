...
{% block sub_title %}{% trans "Szukaj" %}{% endblock sub_title %}
  ...
  <div class="col-12">
    <div class="card post-edit">
      <div class="card-header">
        <h3 class="m-0 card-title h5">{% trans "Przeszukaj fora" %}</h3>
      </div>
      <div class="card-body">
        <form method="get" action="." class="form">
          ...
          <div class="form-actions">
            <input type="submit" class="btn btn-large btn-primary" value="{% trans "Szukaj" %}" />
          </div>
        </form>
      </div>
    </div>
...
<div class="row">
  <div class="col-12">
    <h1>{% trans "Szukaj" %}
    &nbsp;
    <a href="{% url 'forum_search:search' %}" class="btn btn-sm btn-primary"><i class="fas fa-search"></i>&nbsp;{% trans "Nowe wyszukiwanie" %}</a></h1>
  </div>
</div>
<div class="mb-3 row">
  <div class="col-6 col-md-4 forum-actions-block">
    <p class="mt-1 mb-0 text-muted">
      ...
      Wyszukiwanie zwróciło <b>{{ number_of_results }}</b> rezultat
      {% plural %}
      Wyszukiwanie zwróciło <b>{{ number_of_results }}</b> rezultatów
      {% endblocktrans %}
    </p>
  </div>
    ...
    <div class="card resultslist">
      <div class="card-header">
        <h3 class="m-0 card-title h5">
          <i class="fas fa-search"></i>&nbsp;{% trans "Wyniki" %}
        </h3>
      </div>
