...
<form method="post" action="." class="form" enctype="multipart/form-data" novalidate>{% csrf_token %}
  ...
  <ul class="nav nav-tabs nav-justified">
    <li class="nav-item"><a href="#options" class="nav-link active" data-toggle="tab">{% trans "Opcje" %}</a></li>
    <li class="nav-item"><a href="#poll" class="nav-link" data-toggle="tab">{% trans "Ankieta" %}</a></li>
    <li class="nav-item"><a href="#attachments" class="nav-link" data-toggle="tab">{% trans "Załączniki" %}</a></li>
  </ul>
  {% endif %}
  ...
  <div class="form-actions">
    <input type="submit" name="preview" class="btn btn-large btn-default" value="{% trans "Podgląd" %}" />&nbsp;
    <input type="submit" class="btn btn-large btn-primary" value="{% trans "Wyślij" %}" />
  </div>
</form>
