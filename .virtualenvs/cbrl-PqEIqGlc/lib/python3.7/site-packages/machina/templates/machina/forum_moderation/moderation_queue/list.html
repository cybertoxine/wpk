...
<div class="mb-3 row">
  <div class="col-6 col-md-4 forum-actions-block">
    ...
    <p class="mt-1 mb-0 text-muted">
      {% blocktrans with paginator.count as topic_length %}znaleziono {{ topic_length }} postów {% endblocktrans %}
    </p>
    {% endif %}
  </div>
      ...
      <div class="card-header">
        <div class="row panel-row">
          <div class="col-12 col-md-8 post-name-col">
            <h3 class="m-0 card-title h5">{% trans "Kolejka moderacji" %}</h3>
          </div>
          <div class="col-md-2 d-none d-md-block moderation-col">{% trans "Temat" %}</div>
      ...
      <div class="p-0 card-body">
        ...
        <div class="m-0 row">
          ...
          <div class="col-md-2 d-none d-md-block topic-name">
            ...
            <span class="badge badge-secondary">{% trans "Nowy temat" %}</span>
            {% else %}
        ...
        <div class="row m-0 px-3 py-2">
          <div class="p-0 col-12">
            {% trans "Brak postów do zatwierdzenia." %}
          </div>
        </div>
        {% endfor %}
      </div>
