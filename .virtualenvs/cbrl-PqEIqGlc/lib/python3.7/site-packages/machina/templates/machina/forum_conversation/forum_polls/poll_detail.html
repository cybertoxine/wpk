    ...
    <div class="row">
      <div class="col-md-12 poll-content-wrapper">
        ...
        <div class="max-options-indication">
          ...
          {% blocktrans trimmed %}
          Możesz wybrać <b>1</b> option
          {% endblocktrans %}
          {% else %}
          {% blocktrans trimmed with max_options=poll.max_options %}
          Możesz wybrać maksymalnie <b>{{ max_options }}</b> options
          {% endblocktrans %}
          {% endif %}
          {% endif %}
          {% endif %}
        ...
        <div class="form-actions">
          <br />
          <a href="."><i class="fa fa-chevron-circle-right"></i>&nbsp;{% trans "Głosuj" %}</a>
        </div>
        {% elif can_be_completed and has_been_completed and not change_vote_action %}
        <div class="form-actions">
          <br />
          <a href="?change_vote=true"><i class="fa fa-chevron-circle-right"></i>&nbsp;{% trans "Zmień głos" %}</a>
        </div>
        {% endif %}
        {% endwith %}
      </div>
