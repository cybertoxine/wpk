  ...
  <div class="col-12">
    ...
    <div class="mt-3 card forumlist">
      <div class="p-0 card-header">
        <div class="row m-0 px-3 py-2">
          ...
          <div class="col-md-1 d-none d-md-block text-center text-nowrap forum-count-col">{% trans "Tematy" %}</div>
          <div class="col-md-1 d-none d-md-block text-center text-nowrap forum-count-col">{% trans "Posty" %}</div>
          <div class="pr-0 col-md-2 col-sm-3 d-none d-sm-block text-nowrap forum-last-post-col">{% trans "Ostatni post" %}</div>
        </div>
      </div>
    ...
    <div class="mt-3 card forumlist">
      <div class="p-0 card-header">
        <div class="row m-0 px-3 py-2">
          <div class="pl-0 col-md-8 col-sm-9 col-12 forum-name-col">
            <h3 class="m-0 card-title h5 text-dark">{% trans "Fora" %}</h3>
          </div>
          <div class="col-md-1 d-none d-md-block text-center text-nowrap forum-count-col">{% trans "Tematy" %}</div>
          <div class="col-md-1 d-none d-md-block text-center text-nowrap forum-count-col">{% trans "Posty" %}</div>
          <div class="pr-0 col-md-2 col-sm-3 d-none d-sm-block text-nowrap forum-last-post-col">{% trans "Ostatni post" %}</div>
    ...
    <div class="row m-0 px-3 py-2 border-bottom">
      ...
      <div class="py-2 col-md-1 d-none d-md-block forum-syndication"><a href="{% url 'forum_feeds:forum_latest_topics_with_descendants' node.obj.slug node.obj.pk %}" title="{% trans 'RSS' %}"><i class="fas fa-rss-square"></i></a></div>
      ...
      <div class="py-2 col-md-2 col-sm-3 d-none d-sm-block forum-link-redirects">
        ...
        {% trans "Łącznie kliknięć:" %}&nbsp;{{ node.obj.link_redirects_count|default:"0" }}
        {% endif %}
      </div>
    {% endif %}
    </div>
    ...
    <div class="mt-3 card forumlist">
      ...
      <div class="p-0 card-body">
        <div class="m-0 px-3 py-2 row">
          <div class="p-0 col-md-12">{% trans "Brak forów." %}</div>
        </div>
      </div>
    </div>
    {% endif %}
