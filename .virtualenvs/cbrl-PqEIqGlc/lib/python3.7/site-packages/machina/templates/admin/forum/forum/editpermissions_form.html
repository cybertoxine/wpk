...
<div class="breadcrumbs">
  ...
  &rsaquo; {% if has_change_permission %}<a href="../../">{% trans "Uprawnienia forum" %}</a>{% endif %}
...
<form action="." method="post" id="permissions_form" novalidate>{% csrf_token %}
  <div>
    <fieldset class="module aligned {{ fieldset.classes }}">
      ...
      <table cellspacing="0" id="forum-permissions-table-dnd">
        <thead>
          <tr>
            <th class="permission-name-cell" scope="col"><div class="text"><span>{% trans "Uprawnienie" %}</span></div></th>
            <th class="not-set-cell" scope="col"><div class="text"><a href="#" id="toggle_notset"><span>{% trans "Nie ustawione" %}</span></a></div></th>
            <th class="granted-cell" scope="col"><div class="text"><a href="#" id="toggle_granted"><span>{% trans "Przyznane" %}</span></a></div></th>
            <th class="not-granted-cell" scope="col"><div class="text"><a href="#" id="toggle_notgranted"><span>{% trans "Nie przyznane" %}</span></a></div></th>
          </tr>
        </thead>
        <tbody>
          {% for field in form %}
  ...
  <div class="submit-row">
    <input type="submit" value="{% trans 'Zapisz' %}" class="default" name="submit" />
  </div>
</form>
{% endblock content %}
